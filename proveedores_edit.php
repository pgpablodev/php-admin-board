        ...
        <div class="container py-3">
            ...
            <main>
                <?php
                    ...
                    include("db.php");
                    $sqlProveedor = "SELECT `proveedor`, `cif`, `calle`, `cp`, `ciudad`, `telefono`, `email` FROM `proveedores`";
                    $sqlProveedor.=" WHERE `id`=".$id;
                    
                    $result=$mysqli->query($sqlProveedor);
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="mb-4">Editar los datos del proveedor <?php echo $nombre ?></h2>
                        <form id="formProveedorEdit" class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" id="btnEditProveedor" class="btn btn-dark">Editar</button>
                    ...
                    if(error==0){
                        $.ajax({
                            ...
                            if(data==1){
                                bootbox.alert({
                                    closeButton: false,
                                    message:"<h3>Proveedor actualizado correctamente</h3>",
                                ...
                                bootbox.dialog({
                                    closeButton: false,
                                    message:"<h3>Error en la actualización del proveedor</h3>",
                                    title:"<i class='fa-solid fa-circle-info fa-3x text-info'></i><span class='text-info'>&nbsp;INFORMACIÓN</span>"
                                });
                            }
